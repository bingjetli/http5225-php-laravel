...
<body>
    ...
    {
      if($links[$i]['name'] === '') echo '<h1>Missing Link Name</h1>';
      else echo '<h1>'.$links[$i]['name'].'</h1>'; 

      if($links[$i]['url'] === '') echo '<p>Missing Link Url</p>';
      else echo '<p>'.$links[$i]['url'].'</p>'; 

      if($links[$i]['description'] === '') echo '<p>Missing Link Description</p>';
      else echo '<p>'.$links[$i]['description'].'</p>'; 

      if($links[$i]['image'] === '') echo '<p>Missing Link Image</p>';
      else echo '<img src="'.$links[$i]['image'].'" alt text="'.$links[$i]['name'].' image">';
